...
export default function AuthHeader() {
  ...
  const menuItems = profile?.type === 'club' 
    ? [
        ...
        { label: 'Mi Club', icon: UserCircle, href: '/dashboard#club' },
        { label: 'Configuración', icon: Settings, href: '/dashboard/settings' },
      ]
    : [
        { label: 'Mi Perfil', icon: UserCircle, href: '/player/dashboard' },
        { label: 'Mis Reservas', icon: Calendar, href: '/player/dashboard/reservas' },
        { label: 'Mis Torneos', icon: Trophy, href: '/player/dashboard/torneos' },
